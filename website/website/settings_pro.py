...
#STATIC_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), os.path.pardir,'website/static'))
STATIC_ROOT ='/var/www/sites/oldboy_web/website/static/'
...
SECRET_KEY = 'e_=+g++j-+pg5w_7=r+9=%yc__wdx-#7z4$s%3v0xlqn87(xxg'
