...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'graduates', fields ['company']
        db.delete_unique(u'app01_graduates', ['company'])

        # Adding field 'graduates.class_name'
        db.add_column(u'app01_graduates', 'class_name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'graduates.class_name'
        db.delete_column(u'app01_graduates', 'class_name')

        # Adding unique constraint on 'graduates', fields ['company']
        db.create_unique(u'app01_graduates', ['company'])
