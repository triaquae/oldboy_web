...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'questions.display_order'
        db.add_column(u'app01_questions', 'display_order',
                      self.gf('django.db.models.fields.IntegerField')(default=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'questions.display_order'
        db.delete_column(u'app01_questions', 'display_order')
