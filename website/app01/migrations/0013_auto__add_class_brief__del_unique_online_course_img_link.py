...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'online_course', fields ['img_link']
        db.delete_unique(u'app01_online_course', ['img_link'])

        # Adding model 'class_brief'
        db.create_table(u'app01_class_brief', (
        ...
        db.send_create_signal(u'app01', ['class_brief'])


    def backwards(self, orm):
        # Deleting model 'class_brief'
        db.delete_table(u'app01_class_brief')

        # Adding unique constraint on 'online_course', fields ['img_link']
        db.create_unique(u'app01_online_course', ['img_link'])


    models = {
        u'app01.class_brief': {
            'Meta': {'object_name': 'class_brief'},
