...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'web_user.photo'
        db.alter_column(u'app01_web_user', 'photo', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'web_user.photo'
        db.alter_column(u'app01_web_user', 'photo', self.gf('django.db.models.fields.URLField')(max_length=200))
