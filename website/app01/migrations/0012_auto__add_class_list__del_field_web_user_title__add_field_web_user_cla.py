...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'web_user.title'
        db.delete_column(u'app01_web_user', 'title')

        # Adding field 'web_user.class_name'
        db.add_column(u'app01_web_user', 'class_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['app01.class_list']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'web_user.title'
        db.add_column(u'app01_web_user', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=30),
                      keep_default=False)

        # Deleting field 'web_user.class_name'
        db.delete_column(u'app01_web_user', 'class_name_id')
